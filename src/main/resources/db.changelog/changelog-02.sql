...
VALUES ('Angels & Demons', 'https://img-cloud.megaknihy.cz/5065845-original/c3400d50d54f292ede06706fd8200f57/angels-and-demons-illuminati-englische-ausgabe.jpg', 'Angels and Demons, the first installment of Dan Brown''s mystery thriller saga, follows symbologist Robert Langdon on an adventure to solve a historical puzzle laid across Rome. Along with recurring protagonist Langdon, the novel establishes many of Brown''s themes including cryptography and conspiracy theories.'),
       ...
       ('Harry Potter and the Philosopher''s Stone', 'https://i2-prod.walesonline.co.uk/incoming/article6890072.ece/ALTERNATES/s615b/hp1.jpg', '"Harry Potter and the Philosopher''s Stone" is J.K. Rowling''s debut novel in the captivating Harry Potter series. It follows the remarkable journey of Harry Potter, a young orphan who discovers his wizarding heritage and attends Hogwarts School of Witchcraft and Wizardry. With loyal friends by his side, Harry embarks on a perilous adventure to safeguard the mysterious Philosopher''s Stone from falling into evil hands.'),
       ('Ready Player One', 'https://pictures.abebooks.com/inventory/md/md31478052345.jpg', '"Ready Player One" is a gripping sci-fi novel set in a dystopian future. In a world where people seek refuge in a virtual reality game called the OASIS, a young gamer named Wade Watts embarks on a thrilling treasure hunt. The late creator of the OASIS has hidden a fortune and control of the game within it, accessible to whoever can solve his challenges. Packed with 1980s pop culture references and nostalgic treasures, the book explores the boundaries between reality and fantasy while celebrating the power of imagination.');
